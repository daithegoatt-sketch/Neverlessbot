...
function helpText(lang) {
  if (lang === 'en') {
    return [
      ...
      '`what prevents Skirk from 90` / `95` / `100` — biggest blockers to that Neverless target',
      '`-quiz` — public interactive Genshin question',
  ...
  return [
    ...
    '`شنو يمنع Skirk من 90` / `95` / `100` — يرتب أكبر العوائق للوصول للهدف الذي تحدده',
    '`-كويز` — سؤال Genshin تفاعلي Public بكل الرومات',
