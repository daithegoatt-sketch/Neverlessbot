...
function helpText(lang) {
  if (lang === 'en') {
    return [
      ...
      '`-flex build Skirk` — public compact shareable build/rating card',
      ...
      '`rate stats Skirk` — rates your current Showcase stats against numeric targets',
      '`compare Skirk with server` — benchmark against linked server builds',
      '`what prevents Skirk from 0..100` — blockers and competitive headroom to the Neverless target you choose',
      '`-quiz` — public Genshin quiz; Repeat can run 1-50 questions with 15 seconds each',
  ...
  return [
    ...
    '`-فلكس بيلد Skirk` — بطاقة مختصرة Public للبيلد والتقييم وتشتغل بكل الرومات',
    ...
    '`قيم احصائيات Skirk` — يقيم إحصائيات شخصيتك الحالية من الـShowcase مقابل الأهداف الرقمية',
    '`قارن Skirk بالسيرفر` — يقارن بيلدك مع الحسابات المربوطة بالسيرفر',
    '`شنو يمنع Skirk من 0..100` — يوضح العوائق ومجال رفع القوة للوصول للرقم الذي تختاره',
    '`-كويز` — كويز Public؛ زر تكرار يشغل من 1 إلى 50 سؤال وكل سؤال له 15 ثانية',
