...
function helpText(lang) {
  if (lang === 'en') {
    return [
      ...
      '`profile` — compact linked-account profile',
      '`Skirk C1 or weapon` — account-aware C1 vs weapon guidance without invented damage numbers',
      ...
      '`-materials Skirk` — Lv.90 + 10/10/10 material totals',
  ...
  return [
    ...
    '`بروفايلي` — ملخص حسابك المربوط وترتيبك وأفضل بيلد ظاهر',
    '`C1 ولا سلاح Skirk` — مقارنة حسب بيلدك وترتيب الأسلحة المنشور بدون أرقام مخترعة',
    ...
    '`-مواد Skirk` — إجمالي مواد Lv.90 + المواهب 10/10/10',
